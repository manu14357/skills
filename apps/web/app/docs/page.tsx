  ...
  return (
    <div className="max-w-3xl space-y-14">
      <div className="border-b border-border pb-8">
        ...
        <h1 className="text-3xl font-bold text-text-primary md:text-4xl">ASkills</h1>
        <p className="mt-3 text-base text-text-muted">
          ASkills is a fully open registry where every skill lives as{" "}
...
askills add manu14357/askills --skill frontend-design -a cursor
...
askills add manu14357/askills --global`}
        ...
        <div className="space-y-2">
          ...
          <pre className="overflow-x-auto rounded-md border border-border bg-surface p-5 text-xs leading-relaxed text-text-primary">
{`askills list                  # all skills in the registry
askills list --installed       # skills installed on this machine
askills find <query>           # search by name or description
askills check                  # check for updates
askills update                 # update all installed skills
askills remove <skill>         # remove one skill
askills remove --all           # remove all installed skills
askills init <name>            # scaffold a new SKILL.md`}
          </pre>
        </div>
      </section>
      ...
      <section className="space-y-2 border-t border-border pt-8">
        ...
        <p className="text-sm text-text-muted">
          Ready to contribute?{" "}
          <a href="https://github.com/manu14357/askills/fork" target="_blank" rel="noopener noreferrer" className="text-primary underline-offset-2 hover:underline">
